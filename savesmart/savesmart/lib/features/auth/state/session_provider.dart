...
import '../../deposits/data/nominee_repository.dart';
import '../../deposits/domain/deposit.dart';
import '../../deposits/domain/nominee.dart';
...
class AppSession extends ChangeNotifier {
  AppSession._()
    ...
    _nomineeRepository = NomineeRepository(_client);
  ...
  late final NomineeRepository _nomineeRepository;
  ...
  Future<void> login({required String phone, required String pin}) async {
    ...
    try {
      ...
      _portfolioDeposits
        ..clear()
        ..addAll(apiDeposits);
      _nominees = await _nomineeRepository.list();
    } finally {
      _isLoading = false;
      notifyListeners();
    }
  ...
  Future<void> saveNominees(List<Nominee> nominees) async {
    _nominees = await _nomineeRepository.save(nominees);
    notifyListeners();
  }
